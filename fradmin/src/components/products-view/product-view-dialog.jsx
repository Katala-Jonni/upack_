        ...
        <div>
          <Grid container spacing={3}>
            ...
            <Grid item md={6} xs={12} alignSelf="center">
              ...
              {!cartItem?.qty ? <Button size="large" color="primary" variant="contained" onClick={handleCartAmountChange(product.count)} sx={{
              height: 45
            }}>
                  Купить
                ...
                p: ".6rem",
                height: 45
              }} onClick={handleCartAmountChange(cartItem?.qty - product.count)}>
