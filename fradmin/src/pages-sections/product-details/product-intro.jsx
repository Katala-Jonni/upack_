    ...
    <Grid container spacing={3} justifyContent="space-around">
      ...
      <Grid item md={6} xs={12} alignItems="center">
        ...
        <FlexBox overflow="auto">
          {images.map((url, ind) =>
            <FlexRowCenter key={ind} width={64} height={64} minWidth={64} bgcolor="white" border="1px solid"
                           borderRadius="10px" ml={ind === 0 ? 'auto' : 0}
                           style={{
                             cursor: 'pointer'
      ...
      <Grid item md={6} xs={12} alignItems="center">
        ...
        <FlexBox alignItems="center" flexDirection='space-between' mb={1}>
          <FlexBox mr={1}>
            <div>{'Артикул'}</div>
          </FlexBox>
          <FlexBox>
        ...
        <Box pt={1} mb={3}>
          ...
          {/*<Box color="inherit">В наличии</Box>*/}
        </Box>

        {
          /* ADD TO CART BUTTON */
        }
        {!cartItem?.qty ? <Button color="primary" variant="contained" onClick={handleCartAmountChange(mockCount)} sx={{
          mb: 4.5,
          px: '1.75rem',
          height: 40
        }}>
          ...
          <Button size="small" sx={{
            p: 1
          }} color="primary" variant="outlined" onClick={handleCartAmountChange(cartItem?.qty - mockCount)}>
