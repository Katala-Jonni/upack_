...
export default function UserInfo({
  ...
  return <Card sx={{
    ...
    ...(downMd && {
      ...
      <TableRowItem title="Имя" value={user.name.firstName} />
      <TableRowItem title="Фамилия" value={user.name.lastName} />
      <TableRowItem title="E-mail" value={user.email} />
      <TableRowItem title="Телефон" value={user.phone} />
